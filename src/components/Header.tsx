  ...
  return (
    <>
      ...
      >
        ...
        {/* Nav */}
        <nav className="flex items-center gap-8 lg:gap-14 ml-auto text-[15px] lg:text-[15px] lowercase font-light tracking-normal lg:tracking-[0.40em] md:-mt-8 lg:-mt-[72px]">
          {navLinks.map((link) => {
